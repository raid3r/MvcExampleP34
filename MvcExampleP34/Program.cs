...
/*
 * Зробити сторінку профілю користувача
 * Додати випадающе меню в шапку сайту з посиланнями на Профіль та Вихід (справа)
 * На сторінці Профілю показати інформацію про користувача (Id та Email)
 * 
 * 
 * 
 */
